...
let singularity = '2023-09-08 | 22:50 | 09:46 | 3   10:31 x JPY x Industrial Production (MoM) (Jun) x 0.6 x 327316 x 88888 x normal ||'
...
let ws = new  WebSocket('wss://live.tradingeconomics.com/socket.io/?key=20220413&url=%2Fcalendar&EIO=4&transport=websocket&sid='+cassiopeia);
 ...
 ws.on('open', () => {
    if(i == 20){ console.log('Econ webSocket connected'); }
    ws.send('2probe')
    ws.send('5');
